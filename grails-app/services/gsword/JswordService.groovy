...
//        println "do "+b
	...
	println "exception in memorversie:"
    }
//     result
...
println "done index..."
  ...
  private SAXEventProvider getOSISProvider(String bookInitials, Key key) throws BookException, NoSuchKeyException {
	...
	println "JSwordService getOSISProvider exception:bini="+bookInitials+" key:"+key
             //println "it is :"+data
    }
    }
    return provider;
  ...
  public int getCardinality(String bookInitials, String reference) throws NoSuchKeyException {
	...
	//reference=StringEscapeUtils.unescapeHtml(reference?.trim())
	//println "ref after unescape:"+reference
  ...
  private BookData getBookData(String bookstring, String reference, int start, int count) throws NoSuchKeyException {
	...
	println "Exception getting ${reference} from ${books[0]}"
	}
  ...
  public String getPlainText(String bookInitials, String reference) {
    ...
    try {
     ...
     //println "getPlainText from "+bookInitials +" for "+reference
    }
    return result;
  }
  ...
  public List getChapters(String bible) {
    ...
    try {
     ...
     //println "getChapters from from "+bible
    }
