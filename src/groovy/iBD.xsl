  ...
  <xsl:template name="lemma">
    ...
    <xsl:choose>
      <xsl:when test="$separator = ''">
        ...
        <sub class="strongs"><button onclick='doProtocol(&quot;{$protocol}&quot;,&quot;{$orig-lemma}&quot;);'><xsl:value-of select="format-number(substring($orig-lemma,2),'#')"/></button></sub>
      </xsl:when>
      <xsl:otherwise>
        ...
        <sub class="strongs"><button onclick='doProtocol(&quot;{$protocol}&quot;,&quot;{substring-before($orig-lemma, $separator)}&quot;);'><xsl:value-of select="format-number(substring(substring-before($orig-lemma, $separator),2),'#')"/></button>, </sub>
        <xsl:call-template name="lemma">
  ...
  <xsl:template name="morph">
    ...
    <xsl:choose>
      <xsl:when test="$separator = ''">
        ...
        <sub class="morph"><button onclick='doProtocol(&quot;{$protocol}&quot;,&quot;{$orig-morph}&quot;);'><xsl:value-of select="$orig-morph"/></button></sub>
      </xsl:when>
      <xsl:otherwise>
        ...
        <sub class="morph"><button onclick='doProtocol(&quot;{$protocol}&quot;,&quot;{substring-before($orig-morph, $separator)}&quot;);'><xsl:value-of select="substring-before($orig-morph, $separator)"/></button>, </sub>
        <xsl:call-template name="morph">
